...
class Nodes(models.Model):
	...
	coord_lat			=	models.DecimalField(decimal_places=4, max_digits=10, null=True, blank=True, default=0)
	coord_lng			=	models.DecimalField(decimal_places=4, max_digits=10, null=True, blank=True, default=0)
